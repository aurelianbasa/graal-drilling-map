...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-7877206.848124, 6393404.677546, -7841220.607785, 6438633.392442], maxZoom: 20, minZoom: 8
    })
});
...
map.getView().fit([-7877206.848124, 6393404.677546, -7841220.607785, 6438633.392442], map.getSize());
